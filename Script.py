...
ɪ ᴀᴍ ᴘᴏᴡᴇʀғᴜʟ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ᴡɪᴛʜ ʟɪɴᴋsʜᴏʀᴛᴇɴᴇʀ ʙᴏᴛ

ʏᴏᴜ ᴄᴀɴ ᴜꜱᴇ ᴀꜱ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ᴡɪᴛʜ ʟɪɴᴋsʜᴏʀᴛᴇɴᴇʀ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ
ɪᴛꜱ ᴇᴀꜱʏ ᴛᴏ ᴜꜱᴇ ɪᴜꜱᴛ ᴀᴅᴅ ᴍᴇ ᴀꜱ ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ɪ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇʀᴇ ᴍᴏᴠɪᴇꜱ ᴡɪᴛʜ ʏᴏᴜʀ ʟɪɴᴋꜱʜᴏʀᴛᴇɴᴇʀ...</a></b>"""
    HELP_TXT = """
ʜᴇʏ ʙʀᴏ 🥶
...
‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/Omnibotz'>Oᴍɴɪ Bᴏᴛᴢ​​</a>
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/Omnibotz)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
• ꜰᴜʟʟ ɴᴀᴍᴇ : Oᴍɴɪ Bᴏᴛᴢ
• ᴜꜱᴇʀɴᴀᴍᴇ : <a href='https://t.me/Omni_HelpBot'>OmniBot's Owner</a>
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='https://t.me/Omni_HelpBot'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
    NORSLTS = """
★ #𝗡𝗼𝗥𝗲𝘀𝘂𝗹𝘁𝘀 ★
...
"""
    ...
    EARN_TXT = """
<b>──────「 <a href='https://t.me/Omnibotz'>ᴇᴀʀɴ ᴍᴏɴᴇʏ</a> 」─────

Now You can start earning 💸 money today with our Simple and easy-to-use bot!

›› Step 1: Add This bot to your group as an admin..

›› Step 2: If you don't Using any shortner website then make account first on <a href='https://omegalinks.in/ref/Lucifer'>Omegalinks.in </a> (You can also use other link shortner website).

›› Step 3: Copy your API from website and then, simply set your website and API Using the
/set_shortner command

› Like this :  /set_shortner <code>Omegalinks.in 95a8195c40d31e0c3b6baa68813fcecb1239f2e9b</code>
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='t.me/Omnibotz'>ꜰᴏxʏ ᴛɢ</a></b>"""
