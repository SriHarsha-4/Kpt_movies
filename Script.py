...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """
<b> {file_caption}\nSize :- {file_size}\nMain Channel: @KPT_Movies [Movie Request Group](buttonurl:https://t.me/+HmLP1gvVcNowN2E1)</b>"""
...
›› Step 2: If you don't Using any shortner website then make account first on <a href='https://ez4short.com/ref/Lucifer86'>Ez4short </a> (You can also use other link shortner website).

›› Step 3: Copy your API from website and then, simply set your website and API Using the
/set_shortner command

› Like this :  /set_shortner <code>anyshortner.in 95a8195c40d31e0c3b6baa68813fceb1239f2e9b</code>
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='t.me/KPT_Movies'>ꜰᴏxʏ ᴛɢ</a></b>"""
